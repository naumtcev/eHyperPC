...
export const PriceBlockProduct = ({ price }: { price: number }) => {
  return (
    <div className="flex flex-col">
      <div className="flex items-center">
        <div className="text-[1.3125rem] text-[#fff]">
          Цена {formatNumberWithSeparate(price)} ₽
        </div>
        <ButtonUI
          variant="ghost"
      ...
      <div>
        <div>
          <span className="text-[#999]  border-dashed border-b border-[#999] cursor-pointer">
            Рассчитать кредит
          </span>
        </div>
      </div>
